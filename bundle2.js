...
},{"./foreign":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Control.Monad.Eff/foreign.js","Prelude":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Prelude/index.js"}],"/Users/Alko/Coding/purescript/purescript-vexflow/output/Control.MonadPlus/index.js":[function(require,module,exports){
// Generated by psc version 0.7.6.1
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Control.Alt/index.js","Prelude":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Prelude/index.js"}],"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Array/foreign.js":[function(require,module,exports){
/* global exports */
"use strict";
...
var vexAccidentalBar2 = [ [ [  ], [  ], [  ], [  ], [  ], [  ], [  ], [  ] ] ];
var vexAccidentalBar = [ [ [ new Data_Tuple.Tuple(0, "#"), new Data_Tuple.Tuple(1, "b") ], [ new Data_Tuple.Tuple(0, "#") ] ], [ [ new Data_Tuple.Tuple(0, "b") ] ], [ [ new Data_Tuple.Tuple(0, "#") ], [  ], [  ], [ new Data_Tuple.Tuple(0, "b") ], [ new Data_Tuple.Tuple(0, "b") ] ] ];
var testVoice = [ {
    pitch: [ "c#/5" ], 
    duration: "2"
}, {
...
var drawVoice = function (context) {
    return function (stave) {
        return function __do() {
            var _9 = VexFlow.createNotes(vexBar2)();
            var _8 = VexFlow.addAccidentals(_9)(vexAccidentalBar2)();
            var _7 = VexFlow.addBeams(_8)();
            var _6 = VexFlow.addNotesToVoice(_8)(VexFlow.createNewVoice(4.0)(4.0))();
            VexFlow.formatter(_6)(260.0)();
            VexFlow.drawVoice(context)(stave)(_6)();
            return VexFlow.drawBeams(_7)(context)();
        };
    };
};
var drawStave = function (renderer) {
    return function (x) {
        return function (y) {
            return function (w) {
                return function (voice) {
                    return function __do() {
                        var _5 = VexFlow.createCtx(renderer)();
                        var _4 = VexFlow.createStave(x)(y)(w)();
                        VexFlow.drawStave(_4)(_5)();
                        return voice(_5)(_4)();
                    };
                };
            };
...
var drawKeySignatureStave = function (renderer) {
    return function (clef) {
        return function (key) {
            return function __do() {
                var _3 = VexFlow.createCtx(renderer)();
                var _2 = VexFlow.createStave(1.0)(1.0)(80.0)();
                VexFlow.createKeySignature(key)(_2)();
                return VexFlow.drawKeyStave(_2)(clef)(_3)();
            };
        };
    };
};
var main = function __do() {
    var _1 = VexFlow.createCanvas("notationCanvas")();
    var _0 = VexFlow.createRenderer(_1)();
    drawKeySignatureStave(_0)("treble")("G")();
    var stave = drawStave(_0)(80.0)(1.0)(280.0);
    stave(drawVoice)();
    var stave2 = drawStave(_0)(360.0)(1.0)(280.0);
    return stave2(drawVoice)();
};
module.exports = {
    voicesCis: voicesCis, 
    testVoice: testVoice, 
    vexAccidentalBar: vexAccidentalBar, 
    vexAccidentalBar2: vexAccidentalBar2, 
    vexBar2: vexBar2, 
    vexBar: vexBar, 
    drawVoice: drawVoice, 
    drawStave: drawStave, 
    drawKeySignatureStave: drawKeySignatureStave, 
    main: main
};

},{"Control.Monad.Eff":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Control.Monad.Eff/index.js","Data.Tuple":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Tuple/index.js","Music":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Music/index.js","Prelude":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Prelude/index.js","VexFlow":"/Users/Alko/Coding/purescript/purescript-vexflow/output/VexFlow/index.js","VexMusic":"/Users/Alko/Coding/purescript/purescript-vexflow/output/VexMusic/index.js"}],"/Users/Alko/Coding/purescript/purescript-vexflow/output/Music/index.js":[function(require,module,exports){
// Generated by psc version 0.7.6.1
"use strict";
var Prelude = require("Prelude");
...
},{"./foreign":"/Users/Alko/Coding/purescript/purescript-vexflow/output/VexFlow/foreign.js","Control.Monad.Eff":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Control.Monad.Eff/index.js","Data.Tuple":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Tuple/index.js","Music":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Music/index.js","Prelude":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Prelude/index.js","VexMusic":"/Users/Alko/Coding/purescript/purescript-vexflow/output/VexMusic/index.js"}],"/Users/Alko/Coding/purescript/purescript-vexflow/output/VexMusic/index.js":[function(require,module,exports){
// Generated by psc version 0.7.6.1
"use strict";
var Data_Array = require("Data.Array");
var Prelude = require("Prelude");
var Data_Tuple = require("Data.Tuple");
var Music = require("Music");
var pitchToString = function (_2) {
    if (_2 instanceof Music.C) {
        return "c";
    };
    if (_2 instanceof Music.D) {
        return "d";
    };
    if (_2 instanceof Music.E) {
        return "e";
    };
    if (_2 instanceof Music.F) {
        return "f";
    };
    if (_2 instanceof Music.G) {
        return "g";
    };
    if (_2 instanceof Music.A) {
        return "a";
    };
    if (_2 instanceof Music.B) {
        return "b";
    };
    throw new Error("Failed pattern match at VexMusic line 31, column 1 - line 32, column 1: " + [ _2.constructor.name ]);
};
...
var isNatural = function (_5) {
    return Prelude["/="](Music.eqAccidental)(_5.value1)(Music.Natural.value);
};
var filterAccidentals = Data_Array.filter(isNatural);
var extractAccidentals = function (_27) {
...
var durationToInt = function (_4) {
    if (_4 instanceof Music.Even && _4.value0 instanceof Music.SixtyFourth) {
        return 64;
    };
    if (_4 instanceof Music.Even && _4.value0 instanceof Music.ThirtySecond) {
        return 32;
    };
    if (_4 instanceof Music.Even && _4.value0 instanceof Music.Sixteenth) {
        return 16;
    };
    if (_4 instanceof Music.Even && _4.value0 instanceof Music.Eighth) {
        return 8;
    };
    if (_4 instanceof Music.Even && _4.value0 instanceof Music.Quarter) {
        return 4;
    };
    if (_4 instanceof Music.Even && _4.value0 instanceof Music.Half) {
        return 2;
    };
    if (_4 instanceof Music.Even && _4.value0 instanceof Music.Whole) {
        return 1;
    };
    if (_4 instanceof Music.Tuplet && _4.value0 instanceof Music.Three) {
        return 3;
    };
    if (_4 instanceof Music.Tuplet && _4.value0 instanceof Music.Five) {
        return 5;
    };
    if (_4 instanceof Music.Tuplet && _4.value0 instanceof Music.Six) {
        return 6;
    };
    if (_4 instanceof Music.Tuplet && _4.value0 instanceof Music.Seven) {
        return 7;
    };
    throw new Error("Failed pattern match at VexMusic line 47, column 1 - line 48, column 1: " + [ _4.constructor.name ]);
};
var cISNote = [ {
    pitch: Music.C.value, 
...
var accidentalToString = function (_3) {
    if (_3 instanceof Music.DoubleFlat) {
        return "bb";
    };
    if (_3 instanceof Music.Flat) {
        return "b";
    };
    if (_3 instanceof Music.Natural) {
        return "";
    };
    if (_3 instanceof Music.Sharp) {
        return "#";
    };
    if (_3 instanceof Music.DoubleSharp) {
        return "##";
    };
    throw new Error("Failed pattern match at VexMusic line 40, column 1 - line 41, column 1: " + [ _3.constructor.name ]);
};
var accidentalToVexFlowAccidental = function (_6) {
    return new Data_Tuple.Tuple(_6.value0, accidentalToString(_6.value1));
};
...
},{"Data.Array":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Array/index.js","Data.Tuple":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Tuple/index.js","Music":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Music/index.js","Prelude":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Prelude/index.js"}],"/Users/Alko/Coding/purescript/purescript-vexflow/output/browserify.js":[function(require,module,exports){
require('Main').main();
