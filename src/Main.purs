...
main = do
  ...
  drawNotation [vexBar] renderer


drawNotation :: Vm.VexFlowMusic -> Vx.VexFlow -> Vx.VexFlowEff
drawNotation music renderer = do
  drawTrebleStaveLine 1.0 testVoice renderer
  drawBassStaveLine 100.0 testVoice renderer
  drawTrebleStaveLine 230.0 testVoice renderer
  drawBassStaveLine 330.0 testVoice renderer
  drawTrebleStaveLine 460.0 testVoice renderer
  drawBassStaveLine 560.0 testVoice renderer
  -- Vx.logger notes
