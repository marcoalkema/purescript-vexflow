...
var main = function __do() {
    ...
    return VexFlow.logger(Music.indexedCis)();
};
...
var pitchToString = function (_3) {
    ...
    throw new Error("Failed pattern match at Music line 48, column 1 - line 49, column 1: " + [ _3.constructor.name ]);
};
...
var extractAccidentals = function (_36) {
...
var isNatural = function (_6) {
    return Prelude["/="](eqAccidental)(_6.value1)(Natural.value);
};
var filterAccidentals = Data_Array.filter(isNatural);
var durationToInt = function (_5) {
    if (_5 instanceof Even && _5.value0 instanceof SixtyFourth) {
        return 64;
    };
    if (_5 instanceof Even && _5.value0 instanceof ThirtySecond) {
        return 32;
    };
    if (_5 instanceof Even && _5.value0 instanceof Sixteenth) {
        return 16;
    };
    if (_5 instanceof Even && _5.value0 instanceof Eighth) {
        return 8;
    };
    if (_5 instanceof Even && _5.value0 instanceof Quarter) {
        return 4;
    };
    if (_5 instanceof Even && _5.value0 instanceof Half) {
        return 2;
    };
    if (_5 instanceof Even && _5.value0 instanceof Whole) {
        return 1;
    };
    if (_5 instanceof Tuplet && _5.value0 instanceof Three) {
        return 3;
    };
    if (_5 instanceof Tuplet && _5.value0 instanceof Five) {
        return 5;
    };
    if (_5 instanceof Tuplet && _5.value0 instanceof Six) {
        return 6;
    };
    if (_5 instanceof Tuplet && _5.value0 instanceof Seven) {
        return 7;
    };
    throw new Error("Failed pattern match at Music line 64, column 1 - line 65, column 1: " + [ _5.constructor.name ]);
};
var cis = {
    pitch: C.value, 
...
var vexnoteToIndexedAccidentals = function (vexFlowNote) {
    ...
    return filterAccidentals(indexedAccidentals);
};
var indexedCis = vexnoteToIndexedAccidentals(cIS);
var accidentalToString = function (_4) {
    if (_4 instanceof DoubleFlat) {
        return "bb";
    };
    if (_4 instanceof Flat) {
        return "b";
    };
    if (_4 instanceof Natural) {
        return "";
    };
    if (_4 instanceof Sharp) {
        return "#";
    };
    if (_4 instanceof DoubleSharp) {
        return "##";
    };
    throw new Error("Failed pattern match at Music line 57, column 1 - line 58, column 1: " + [ _4.constructor.name ]);
};
...
},{"Data.Array":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Array/index.js","Data.Generic":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Generic/index.js","Data.List.Lazy":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.List.Lazy/index.js","Data.Maybe":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Maybe/index.js","Data.Tuple":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Tuple/index.js","Data.Unfoldable":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Data.Unfoldable/index.js","Prelude":"/Users/Alko/Coding/purescript/purescript-vexflow/output/Prelude/index.js","VexFlow":"/Users/Alko/Coding/purescript/purescript-vexflow/output/VexFlow/index.js"}],"/Users/Alko/Coding/purescript/purescript-vexflow/output/Prelude/foreign.js":[function(require,module,exports){
/* global exports */
"use strict";
